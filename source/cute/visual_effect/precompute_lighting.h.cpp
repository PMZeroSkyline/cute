...
std::shared_ptr<TextureCube> render_texture_cube(const std::string hdr_path, int size)
{
    ...
    material->textures[HashedString("iEnvironmentTexture")] = Texture2D::get(hdr_path, true, TextureSampler::make_linear_clamp_to_edge(), false);
